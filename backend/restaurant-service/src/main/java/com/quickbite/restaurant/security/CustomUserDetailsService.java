...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return User.builder()
                .username(username)
                .password("")  // JWT tokens don't need password validation
    ...
    public UserDetails loadUserByUsernameWithRole(String username, String token) throws UsernameNotFoundException {
        try {
            ...
            logger.warn("Restaurant token role extraction failed, falling back to default role for username={}", username);
